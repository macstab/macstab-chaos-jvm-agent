...
/**
 * Synchronous event bus that dispatches {@link com.macstab.chaos.jvm.api.ChaosEvent}s to all
 * registered {@link com.macstab.chaos.jvm.api.ChaosEventListener}s.
 *
