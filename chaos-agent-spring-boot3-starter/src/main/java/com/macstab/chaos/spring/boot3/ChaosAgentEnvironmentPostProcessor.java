 ...
 *
 * <p>Registered via {@code META-INF/spring.factories} under the key {@code
 * org.springframework.boot.env.EnvironmentPostProcessor}. Spring Boot 3 discovers
 ...
 * prepended to the environment exposing {@link #ATTACH_MARKER_PROPERTY}{@code = spring-boot-3}.
