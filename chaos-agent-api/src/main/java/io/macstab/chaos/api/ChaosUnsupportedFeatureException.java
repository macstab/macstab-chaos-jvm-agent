 ...
 * exception is thrown immediately and the scenario is recorded as
 * {@link ChaosDiagnostics.FailureCategory#UNSUPPORTED_RUNTIME}.
 *
 * <p>Known scenarios that trigger this exception:
 *
 * <ul>
 *   <li>{@link ChaosSelector.ThreadSelector} with {@link ChaosSelector.ThreadKind#VIRTUAL} on
 *       JDK 17 or 18 (virtual threads require JDK 21+).
 * </ul>
 */
public class ChaosUnsupportedFeatureException extends RuntimeException {
   ...
   */
  public ChaosUnsupportedFeatureException(String message) {
    super(message);
  }
}
