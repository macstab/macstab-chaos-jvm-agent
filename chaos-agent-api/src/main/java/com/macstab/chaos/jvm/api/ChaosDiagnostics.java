 ...
 * JMX at {@code com.macstab.chaos.jvm:type=ChaosDiagnostics} and drives JFR periodic snapshot
 * events (registered by the bootstrap module when JFR is available).
 *
