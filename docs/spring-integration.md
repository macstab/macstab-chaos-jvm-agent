...
|--------|-------|-------------|----------------------|--------------|
| `chaos-agent-spring-boot3-test-starter` | Test (JUnit 5 + `@SpringBootTest`) | 3.5.13 | `com.macstab.chaos.agent.spring.boot3.test` | `com.macstab.chaos.spring.boot3.test` |
| `chaos-agent-spring-boot4-test-starter` | Test (JUnit 5 + `@SpringBootTest`) | 4.0.5 | `com.macstab.chaos.agent.spring.boot4.test` | `com.macstab.chaos.spring.boot4.test` |
| `chaos-agent-spring-boot3-starter` | Runtime (production / soak / game day) | 3.5.13 | `com.macstab.chaos.agent.spring.boot3` | `com.macstab.chaos.spring.boot3` |
| `chaos-agent-spring-boot4-starter` | Runtime (production / soak / game day) | 4.0.5 | `com.macstab.chaos.agent.spring.boot4` | `com.macstab.chaos.spring.boot4` |
...
org.springframework.context.ApplicationContextInitializer=\
  com.macstab.chaos.spring.boot3.test.ChaosAgentInitializer
```
...
META-INF/spring/org.springframework.context.ApplicationContextInitializer.imports
  → com.macstab.chaos.spring.boot4.test.ChaosAgentInitializer
```
...
META-INF/spring/org.springframework.boot.test.autoconfigure.ImportAutoConfiguration.imports
  → com.macstab.chaos.spring.boot3.test.ChaosTestAutoConfiguration
  → (Boot 4 variant)   com.macstab.chaos.spring.boot4.test.ChaosTestAutoConfiguration
```
